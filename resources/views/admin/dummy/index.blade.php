...
@section('content')
    <div class="text-[32px]  w-full font-light text-white mx-0 md:lg:mx-6 ">
        ...
        <div id="addUser" class="   hidden">
            <div
                class="absolute   right-12 my-5 w-1/2   md:lg:w-1/5 text-black rounded-lg bg-[#A6A5A5] z-50 px-7 py-[26px]">
                <h2 class="font-semibold text-[32px]">Add New Bot</h2>
                ...
                <tbody class="font-semibold text-white ">
                    @foreach ($dummies as $dummy)
                        <tr class=" bg-custom-black ">
                            ...
                            <td class="px-6 py-4">
                                {{ date('Y-m-d', strtotime($dummy->account_expired)) }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $dummy->ip_address }}
                            </td>
                            <td
                                class="px-6 py-4
                            @if ($dummy->status == 'Berjalan') text-[#18A900]
                            @elseif ($dummy->status == 'Tidak Berjalan') text-[#B18B28]
                            @elseif($dummy->status == 'Expired')
                            text-[#CF0404] @endif
                            ">
                                {{ $dummy->status }}
                            </td>
                        ...
                        <div id="setUser" class="hidden  ">
                            <div
                                class="  absolute right-12 my-5 w-2/3  md:lg:w-[37%] text-black rounded-lg bg-[#A6A5A5] z-50 px-7 py-[26px]">
                                <h2 class="font-semibold text-[32px]">Detail Bot Account</h2>
                                ...
                                <div class="overflow- md:lg:grid md:lg:grid-cols-2 gap-10 justify-between">
                                    ...
                                    <div class="block font-medium text-xl">
                                        ...
                                        <div class="block mt-3">
                                            <p>Action</p>
                                            <input type="text"
                                                class="h-[230px] text-[#424242] w-full bg-transparent rounded-lg border-custom-purple mt-1" />
                                        </div>
